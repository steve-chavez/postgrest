...
create or replace function root(integer) returns "application/openapi+json" as $_$
  select '{}'::json;
$_$ language sql;

create or replace function root_int(integer) returns "application/openapi+json" as $_$
  select '{}'::json;
$_$ language sql;

create or replace function root_with_json(json) returns "application/openapi+json" as $_$
  select json_build_object(
    'swagger', '2.0',
    ...
    'server-host', $1->>'server-host',
    'server-port', $1->>'server-port',
    'openapi-server-proxy-uri', $1->>'openapi-server-proxy-uri',
    'db-schemas', $1->'db-schemas',
    'version', $1->>'version'
  )::json;
$_$ language sql;
